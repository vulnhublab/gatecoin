...
#
# Gatecoin documentation build configuration file, created by
...
# - Add Gatecoin path to the path for sphinx to import
sys.path.insert(0, os.path.dirname(os.path.abspath("../gatecoin/")))
...
releases_issue_uri = "https://github.com/gatecoin/gatecoin/issues/%s"
releases_release_uri = "https://github.com/gatecoin/gatecoin/releases/tag/v%s"
...
project = "Gatecoin Network"
author = "Gatecoin Project"
...
latex_documents = [
    (master_doc, "Gatecoin.tex", "Gatecoin Network Documentation", "Gatecoin Project", "manual")
]

# The name of an image file (relative to this directory) to place at the top of
# the title page.
#
latex_logo = "gatecoin.png"
...
man_pages = [(master_doc, "gatecoin", "Gatecoin Network Documentation", [author], 1)]
...
texinfo_documents = [
    (
        master_doc,
        "Gatecoin",
        "Gatecoin Network Documentation",
        author,
        "Gatecoin",
