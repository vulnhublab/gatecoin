...
To get you familiarized with the Gatecoin WebUI we have put together a short introduction to the most important screens of the application.
...
2. Your **UDC balance**. This is the amount of RDN tokens you have deposited
   ...
   :doc:`Gatecoin Services <../gatecoin_services>`. When clicking the button next
...
4. The **address** of your Gatecoin node (you can display the address as a
   QR code).
...
Gatecoin node. To open channels either:
...
.. note::
   ...
   **What is a channel?**
   ...
   Gatecoin is always backed by a on-chain deposit of token. 
