...
To make payments in Gatecoin you first need to join the network by opening channels for the token you want to make payments with.
...
.. note::
   ...
   **What is a token network?**
   ...
   Anyone running a Gatecoin node and owns a token can join a network with
