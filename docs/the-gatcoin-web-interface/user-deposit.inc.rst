...
It will show you the amount of Gatecoin Network Tokens (RDN) you have on-chain, which are necessary for deposits.
...
.. note::
   ...
   **What is the User Deposit Contract (UDC)?**
   ...
   The UDC is a smart contract where you deposit RDN (Gatecoin Network Tokens) for later paying the :doc:`Gatecoin Services <../gatecoin_services>`.
