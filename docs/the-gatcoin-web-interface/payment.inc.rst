...
Payment channels allow for Gatecoin transfers to be made without the need to involve the actual blockchain.
...
.. note::
   ...
   **Minting tokens**
   ...
   When running Gatecoin on a testnet the WebUI lets you mint tokens to fund
...
.. note::
   ...
   **How do payment channels work?**
   ...
   A payment channel in Gatecoin is always backed by an on-chain deposit of
