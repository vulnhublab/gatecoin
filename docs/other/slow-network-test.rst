Testing Gatecoin on a slow network
================================

In order to analyze Gatecoin performance on slow networks, it is useful to have a way of
...
Now we just need to start Gatecoin from within the network namespace that we created:
