...
We see this rear its ugly head on the Gatecoin mainnet where Gatecoin nodes
...
somewhere <https://github.com/gatecoin/gatecoin/issues/62090>`__ or
...
are code paths in the Gatecoin code base that are only required by the CM
...
transactions at times after joining a TN can make Gatecoin look bad at
...
a layer above Gatecoin would simplify the Gatecoin core and would be a
better fit for many use cases.

See https://github.com/gatecoin/gatecoin/issues/4730 for previous
...
need to be part of the Gatecoin client’s core. Removing it from the client
