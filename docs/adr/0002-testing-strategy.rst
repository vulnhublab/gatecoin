Better testing framework for the entire Gatecoin suite (client, MS and PFS)
*************************************************************************
...
* Have a way of testing all Gatecoin components

Considered Options
------------------

* **Option1:** New repo that integrate the client with the MS/PFS with rewritten fixtures that only spins up one blockchain per test suit session. `Link to meeting discussing this <https://github.com/gatecoin/team/issues/357>`_
