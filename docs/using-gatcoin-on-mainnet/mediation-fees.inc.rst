...
Gatecoin lets users pay anyone in the network by using a path of connected
...
post <https://medium.com/gatecoin/dynamic-mediation-fees-in-gatecoin-explained-dbc29f032e4b>`__
and the `architecture decision
record <https://github.com/gatecoin/gatecoin-services/blob/master/adr/003-mediation-fees.md>`__.

Default Fee Schedule
--------------------

You don't need to configure the fee schedule yourself if you don't want
to, since Gatecoin comes with a default fee schedule. The default values
are
...
As with all Gatecoin settings, you can get a short summary of the
available options by running ``gatecoin --help``:
