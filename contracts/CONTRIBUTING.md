# Gatecoin Smart Contracts Development Guide
...
This repository follows the same guidelines as the Gatecoin Client, regarding the Python code used in tests and scripts: https://github.com/gatecoin/gatecoin/blob/master/CONTRIBUTING.md#coding-style.
...
Read our [Test Guide](./gatecoin_contracts/tests/README.md)
...
- for core contracts: `./gatecoin_contracts/data/source/gatecoin`
- for 3rd party services: `./gatecoin_contracts/data/source/services`
- libraries: `./gatecoin_contracts/data/source/lib`
- non-production test contracts: `./gatecoin_contracts/data/source/test`

### Constants

Update [package constants](./gatecoin_contracts/constants.py) with the new contract's name, events, gas requirements etc.

Note: gas requirements are currently calculated using [./gatecoin_contracts/tests/test_print_gas.py](./gatecoin_contracts/tests/test_print_gas.py), so the contract needs to be added here. This is not optimal: https://github.com/gatecoin/gatecoin/issues/16

### Tests

- add a new file with the new contract fixture in [./gatecoin_contracts/tests/fixtures](./gatecoin_contracts/tests/fixtures), to be used across tests and add that file to [./gatecoin_contracts/tests/fixtures/__init__.py](./gatecoin_contracts/tests/fixtures/__init__.py)
- read our Test Guide for how to add new tests for the contract
- make sure it's covered by our [compilation tests](./gatecoin_contracts/tests/test_contracts_compilation.py)
- add it to the [deployment tests](./gatecoin_contracts/tests/test_deploy_script.py)
...
https://github.com/gatecoin/gatecoin/blob/810ea24b61221f74939a732e6f20f20184039507/gatecoin_contracts/contract_manager.py#L250-L267


### Deployment

Make sure the new contract's precompiled data and deployment info is included in [./gatecoin_contracts/data](./gatecoin_contracts/data), by adding the contract to the [deployment process](./gatecoin_contracts/deploy/__main__.py)

- if it is a core contract, add it to [deploy_gatecoin_contracts](https://github.com/gatecoin/gatecoin/blob/810ea24b61221f74939a732e6f20f20184039507/gatecoin_contracts/deploy/__main__.py#L436) and to [verify_deployed_contracts](https://github.com/gatecoin/gatecoin/blob/810ea24b61221f74939a732e6f20f20184039507/gatecoin_contracts/deploy/__main__.py#L616)
- if it is a service contract, add it to [deploy_service_contracts](https://github.com/gatecoin/gatecoin/blob/810ea24b61221f74939a732e6f20f20184039507/gatecoin_contracts/deploy/__main__.py#L492) and to [verify_deployed_service_contracts](https://github.com/gatecoin/gatecoin/blob/810ea24b61221f74939a732e6f20f20184039507/gatecoin_contracts/deploy/__main__.py#L686)
- add it to the [Etherscan verification script](./gatecoin_contracts/deploy/etherscan_verify.py)

Check if the deployment info file path still stands: https://github.com/gatecoin/gatecoin/blob/810ea24b61221f74939a732e6f20f20184039507/gatecoin_contracts/contract_manager.py#L270-L274
