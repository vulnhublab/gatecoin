...
import "gatecoin/Token.sol";
import "gatecoin/Utils.sol";
import "gatecoin/SecretRegistry.sol";
import "gatecoin/Controllable.sol";

/// @title TokenNetwork
/// @notice Stores and manages all the Gatecoin Network channels that use the
...
contract TokenNetwork is Utils, Controllable {
    ...
    struct UnlockData {
        // keccak256 hash of the pending locks from the Gatecoin client
        bytes32 locksroot;
        ...
        public
    {
        ...
        // provided by the official Gatecoin client, the participants will be able
        ...
        // are not within the constraints enforced by the official Gatecoin client),
        // therefore it cannot ensure correctness. Users MUST use the official
        // Gatecoin clients for signing balance proofs.
    ...
    /// Check https://github.com/gatecoin/gatecoin/issues/188 for the settlement
