...
from gatecoin_contracts.constants import PRECOMPILED_DATA_FIELDS, DeploymentModule
from gatecoin_contracts.contract_manager import ContractManager, contracts_data_path
...
def contracts_source_path_of_deployment_module(module: DeploymentModule) -> Path:
    if module == DeploymentModule.RAIDEN:
        return contracts_source_path(contracts_version=None)["gatecoin"]
...
def contracts_source_path_with_stem(stem: Path) -> Dict[str, Path]:
    ...
    return {
        ...
        "gatecoin": _BASE.joinpath(stem, "gatecoin"),
