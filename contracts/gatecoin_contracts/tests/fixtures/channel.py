...
from gatecoin_contracts.constants import TEST_SETTLE_TIMEOUT, ChannelState, MessageTypeId
...
from gatecoin_contracts.tests.utils.constants import DEPLOYER_ADDRESS, OnchainBalanceProof
from gatecoin_contracts.utils.proofs import (
    hash_balance_data,
    sign_balance_proof,
    sign_balance_proof_message,
    sign_withdraw_message,
)
from gatecoin_contracts.utils.type_aliases import (
    AdditionalHash,
    BalanceHash,
    ChannelID,
    Locksroot,
...
def create_channel(token_network: Contract) -> Callable:
    def get(A: HexAddress, B: HexAddress) -> Tuple:
        ...
        channel_state = token_network.functions.getChannelState(channel_identifier, A, B).call()
