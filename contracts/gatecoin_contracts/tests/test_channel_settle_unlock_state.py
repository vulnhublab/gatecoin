...
from gatecoin_contracts.constants import TEST_SETTLE_TIMEOUT, ParticipantInfoIndex
from gatecoin_contracts.tests.fixtures.channel import call_settle
from gatecoin_contracts.tests.fixtures.channel_test_values import (
    channel_settle_invalid_test_values,
    channel_settle_test_values,
)
from gatecoin_contracts.tests.utils import (
...
def test_channel_settle_old_balance_proof_values(
    ...
    # Where a valid balance proof is a balance proof that respects the Gatecoin client
    # value contraints, as defined here:
    # https://github.com/gatecoin/gatecoin/issues/188#issuecomment-404752095
    (
