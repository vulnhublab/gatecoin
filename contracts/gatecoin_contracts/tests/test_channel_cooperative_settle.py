...
from gatecoin_contracts.constants import EMPTY_ADDRESS, ChannelEvent
from gatecoin_contracts.tests.utils import EMPTY_LOCKSROOT, call_and_transact
from gatecoin_contracts.utils.events import check_channel_settled, check_withdraw_2
