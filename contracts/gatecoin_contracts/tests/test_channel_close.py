...
from gatecoin_contracts.utils.events import check_channel_closed
...
def test_close_nonexistent_channel(token_network: Contract, get_accounts: Callable) -> None:
    ...
    settle_block_number = token_network.functions.settleable_after(
...
def test_close_nonce_zero(
    ...
    # The Gatecoin client enforces that the nonce is > 0 if off-chain transfers are made.
    (
        _,
        _,
        B_is_the_closer,
