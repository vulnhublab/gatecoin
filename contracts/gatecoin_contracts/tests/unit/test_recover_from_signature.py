...
from gatecoin_contracts.constants import EMPTY_ADDRESS, MessageTypeId
from gatecoin_contracts.utils.proofs import eth_sign_hash_message, pack_balance_proof
from gatecoin_contracts.utils.signature import sign
