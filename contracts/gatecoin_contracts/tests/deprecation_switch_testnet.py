...
from gatecoin_contracts.deploy.__main__ import setup_ctx
...
def deprecation_test(
    ...
    # We deploy the Gatecoin Network contracts and register a token network
...
def deprecation_test_setup(
    ...
    deployed_contracts = deployer.deploy_gatecoin_contracts(
