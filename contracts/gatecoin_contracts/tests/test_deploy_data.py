...
from gatecoin_contracts.utils.versions import contracts_version_provides_services
...
@pytest.mark.parametrize("chain_id", TARGET_CHAINS)
def test_deploy_data_has_fields_gatecoin(version: Optional[str], chain_id: ChainID) -> None:
