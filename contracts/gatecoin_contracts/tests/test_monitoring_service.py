...
from gatecoin_contracts.utils.proofs import sign_reward_proof
from gatecoin_contracts.utils.type_aliases import TokenAmount
...
def test_monitoring_service_deploy_with_token_address_zero(
    ...
    # https://github.com/gatecoin/gatecoin/issues/1329
