...
from gatecoin_contracts.tests.utils import call_and_transact
from gatecoin_contracts.tests.utils.constants import DEPLOYER_ADDRESS, SERVICE_DEPOSIT, UINT256_MAX
from gatecoin_contracts.utils.pending_transfers import (
    get_locked_amount,
    get_pending_transfers_tree,
)
from gatecoin_contracts.utils.proofs import sign_one_to_n_iou, sign_reward_proof
from gatecoin_contracts.utils.type_aliases import ChainID, TokenAmount
...
def print_gas_secret_registry(secret_registry_contract: Contract, print_gas: Callable) -> None:
    ...
    for batch_size in (1, 2, 3):
        ...
        print_gas(
            txn_hash,
            CONTRACT_SECRET_REGISTRY + ".registerSecretBatch" + str(batch_size),
        )
