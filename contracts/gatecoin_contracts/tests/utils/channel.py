...
from gatecoin_contracts.constants import LOCKSROOT_OF_NO_LOCKS
from gatecoin_contracts.tests.utils.constants import EMPTY_ADDITIONAL_HASH, UINT256_MAX
...
def get_participant_available_balance(
    ...
    The available balance is used in the Gatecoin client, in order to check if a
