...
from gatecoin_contracts.constants import CONTRACT_LIST, CONTRACT_TOKEN_NETWORK, DeploymentModule
...
from gatecoin_contracts.contract_source_manager import (
...
def etherscan_verify_contract(
    ...
    Visit {etherscan_url}
    Use gatecoin_contracts/deploy/joined.sol."""
