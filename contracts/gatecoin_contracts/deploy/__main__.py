...
from gatecoin_contracts.contract_manager import DeployedContracts, contracts_deployed_path
...
from gatecoin_contracts.utils.private_key import get_private_key
...
from gatecoin_contracts.utils.versions import contracts_version_with_max_token_networks
...
def gatecoin(
    ...
    deployed_contracts_info = deployer.deploy_gatecoin_contracts(
