...
from gatecoin_contracts.contract_source_manager import ContractSourceManager, contracts_source_path
from gatecoin_contracts.deploy.contract_verifier import ContractVerifier
from gatecoin_contracts.utils.file_ops import load_json_from_path
from gatecoin_contracts.utils.signature import private_key_to_address
from gatecoin_contracts.utils.transaction import check_successful_tx
from gatecoin_contracts.utils.type_aliases import ChainID, PrivateKey
from gatecoin_contracts.utils.versions import (
...
class ContractDeployer(ContractVerifier):
    ...
    def deploy_gatecoin_contracts(
        ...
        """Deploy all required gatecoin contracts and return a dict of contract_name:address
