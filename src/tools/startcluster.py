...
from gatecoin.utils.typing import ChainID, List, Port, PrivateKey, TokenAmount
from gatecoin_contracts.constants import CHAINNAME_TO_ID

NUM_GETH_NODES = 3
NUM_GATECOIN_ACCOUNTS = 10
START_PORT = 30301
START_RPCPORT = 8101


DEFAULT_ACCOUNTS_SEEDS = [
    "127.0.0.1:{}".format(START_PORT + i).encode() for i in range(NUM_GATECOIN_ACCOUNTS)
]
