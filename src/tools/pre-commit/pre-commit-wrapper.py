#!/usr/bin/env python3
"""
This is a small helper to run pylint and mypy with the Gatecoin dev requirements installed in the
...
REQUIREMENTS_HASH_FILE_NAME = "_GATECOIN_REQUIREMENTS_HASH.txt"
