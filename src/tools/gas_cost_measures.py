...
from gatecoin.constants import TRANSACTION_GAS_LIMIT_UPPER_BOUND
...
from gatecoin_contracts.utils.pending_transfers import get_pending_transfers_tree
...
class ContractTester:
    def __init__(self, generate_keys=0):
        ...
        self.contract_manager = ContractManager(
            contracts_precompiled_path(GATECOIN_CONTRACT_VERSION)
        )
