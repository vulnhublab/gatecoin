...
from gatecoin.storage.wal import WriteAheadLog, dispatch
from gatecoin.transfer import channel, node, views
...
def get_node_balances(
    ...
    channels = [
        gatecoin_channel
        for gatecoin_channel in channels
        if gatecoin_channel.canonical_identifier.token_network_address  # type: ignore
