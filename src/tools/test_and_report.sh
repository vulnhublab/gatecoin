...
#
# ONLY=gatecoin/transfer/node.py test_and_report.sh
#
## Same as above but more verbose (SHOW is configured implicitly above)
#
# ONLY=gatecoin/transfer/node.py SHOW=gatecoin_transfer_node_py.html test_and_report.sh
#
...
#
# SUITE=gatecoin/tests/unit/transfer/test_node.py test_and_report.sh
#
...
SUITE=${SUITE:-gatecoin/tests/unit gatecoin/tests/fuzz}
