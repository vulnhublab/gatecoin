...
from gatecoin.utils.typing import MYPY_ANNOTATION, BlockNumber, BlockTimeout, Optional
    ...
    def make_request() -> BlockNumber:
        response = requests.get(
            ...
            headers={
                ...
                "USER-AGENT": f"gatecoin-{pkg_resources.require(gatecoin.__name__)[0].version}",
            },
        )
