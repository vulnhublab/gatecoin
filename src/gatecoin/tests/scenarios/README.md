...
The scenarios listed within this folder are getting executed nightly by the [scenario player](https://github.com/gatecoin/scenario-player/) or can be executed locally after installing the scenario player.

## Purpose

The scenarios serve the following purpose

- Full end-to-end tests covering contracts, transport, Gatecoin client, blockchain, eth-client, monitoring service, pathfinding service and service contracts
- Testing on a "dirty" blockchain
- User acceptance tests
- Testing in a distributed environment
- Understanding how Gatecoin and the Gatecoin Services can be used and interact

## Writing scenarios

If you want to write a new scenario you can check out the [following example file](https://github.com/gatecoin/scenario-player/blob/master/examples/scenario-example-v2.yaml).
...
opening channels, depositing, transferring, waiting keeping the gatecoin node alive for
a long time in the process checking that the gatecoin network
