...
from gatecoin.transfer.mediated_transfer.mediator import find_intersection
...
def get_amount_with_fees(
    ...
    This function is also used by the PFS. Therefore the parameters should not be Gatecoin state
    objects.
