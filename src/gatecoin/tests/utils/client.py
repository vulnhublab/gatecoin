from gatecoin.constants import TRANSACTION_INTRINSIC_GAS
from gatecoin.network.rpc.client import EthTransfer, JSONRPCClient
...
def burn_eth(rpc_client: JSONRPCClient, amount_to_leave: int = 0) -> None:
    """Burns all the ETH on the account of the given gatecoin service"""
