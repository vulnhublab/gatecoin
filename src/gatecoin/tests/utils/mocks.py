...
from gatecoin.storage.serialization import JSONSerializer
from gatecoin.storage.sqlite import SerializedSQLiteStorage
from gatecoin.storage.wal import WriteAheadLog
from gatecoin.tests.utils import factories
from gatecoin.tests.utils.factories import UNIT_CHAIN_ID, make_token_network_registry_address
from gatecoin.tests.utils.transfer import create_route_state_for_route
from gatecoin.transfer import node, views
from gatecoin.transfer.state import ChainState, NettingChannelState
from gatecoin.transfer.state_change import Block
...
RoutesDict = Dict[TokenAddress, Dict[Tuple[Address, Address], List[List[GatecoinService]]]]
...
def make_gatecoin_service_mock(
...
class PFSMock:
    ...
    def add_apps(self, apps: List[GatecoinService], add_pfs_config=True):
        for app in apps:
    ...
    def set_route(self, token_address: TokenAddress, route: List[GatecoinService]):
