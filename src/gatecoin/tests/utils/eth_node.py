...
from gatecoin.tests.fixtures.constants import DEFAULT_PASSPHRASE
from gatecoin.tests.utils.genesis import GENESIS_STUB, PARITY_CHAIN_SPEC_STUB
from gatecoin.utils.ethereum_clients import parse_geth_version
from gatecoin.utils.formatting import to_checksum_address
from gatecoin.utils.http import JSONRPCExecutor
from gatecoin.utils.keys import privatekey_to_address, privatekey_to_publickey
from gatecoin.utils.typing import Address, Any, ChainID, Dict, List, NamedTuple, Port, TokenAmount
...
def parity_keystore(datadir: str) -> str:
    return os.path.join(datadir, "keys", "GatecoinTestChain")
