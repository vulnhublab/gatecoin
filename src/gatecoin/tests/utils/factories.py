...
from gatecoin.constants import EMPTY_SIGNATURE, LOCKSROOT_OF_NO_LOCKS, UINT64_MAX, UINT256_MAX
...
from gatecoin.messages.transfers import Lock, LockedTransfer, LockExpired, RefundTransfer, Unlock
from gatecoin.transfer import channel, token_network, views
...
from gatecoin.transfer.state_change import ContractReceiveChannelNew, ContractReceiveRouteNew
...
from gatecoin.utils.packing import pack_balance_proof
...
def make_chain_state(
    ...
    chain_state.tokennetworkaddresses_to_tokennetworkregistryaddresses[token_network_address] = (
