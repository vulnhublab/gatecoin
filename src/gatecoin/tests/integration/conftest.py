...
from gatecoin.tests.integration.fixtures.blockchain import *  # noqa: F401,F403
from gatecoin.tests.integration.fixtures.gatecoin_network import *  # noqa: F401,F403
from gatecoin.tests.integration.fixtures.smartcontracts import *  # noqa: F401,F403
from gatecoin.tests.integration.fixtures.transport import *  # noqa: F401,F403
...
def pytest_collection_finish(session):
    def unsafe(item):
        has_nodes = (
            "gatecoin_network" in item.fixturenames or "gatecoin_chain" in item.fixturenames
        )
