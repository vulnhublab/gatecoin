...
from gatecoin.blockchain.events import get_contract_events
from gatecoin.constants import BLOCK_ID_LATEST, GENESIS_BLOCK_NUMBER, STATE_PRUNING_AFTER_BLOCKS
from gatecoin.exceptions import NoStateForBlockIdentifier
...
from gatecoin.tests.utils.events import must_have_event
...
from gatecoin.utils.typing import Address, BlockNumber, Dict, List, PrivateKey, Secret
from gatecoin_contracts.constants import CONTRACT_SECRET_REGISTRY
...
def test_concurrent_secret_registration(secret_registry_proxy: SecretRegistry, monkeypatch):
    ...
    This checks that Gatecoin will not send unecessary transactions to register
