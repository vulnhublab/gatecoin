...
from gatecoin.constants import MATRIX_AUTO_SELECT_SERVER, RoutingMode
from gatecoin.exceptions import PFSReturnedError, GatecoinError, ServiceRequestFailed
...
from gatecoin.settings import DEFAULT_PATHFINDING_MAX_FEE
from gatecoin.tests.unit.test_pfs_integration import make_address_metadata
from gatecoin.tests.utils.factories import UNIT_CHAIN_ID, make_address, make_signer
from gatecoin.tests.utils.mocks import mocked_json_response
...
def test_configure_pfs(service_registry_address, private_keys, web3, contract_manager):
    ...
    patch_random = patch("gatecoin.network.pathfinding.get_random_pfs", return_value="http://foo")
...
def test_query_user():
    ...
    with patch("gatecoin.network.pathfinding.session") as session_mock:
        # success
