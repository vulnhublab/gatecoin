...
from gatecoin.messages.transfers import Lock, LockedTransfer
...
def test_failsfast_lockedtransfer_exceeding_distributable(
    gatecoin_network: List[GatecoinService], token_addresses, deposit
):
...
def test_receive_lockedtransfer_invalidsender(
    gatecoin_network: List[GatecoinService], token_addresses, deposit, reveal_timeout
):
    app0, app1 = gatecoin_network
    token_address = token_addresses[0]
...
def test_receive_lockedtransfer_invalidrecipient(
    gatecoin_network: List[GatecoinService], token_addresses, reveal_timeout, deposit
):
    app0, app1 = gatecoin_network
    token_address = token_addresses[0]
    token_network_address = views.get_token_network_address_by_token_address(
...
def test_received_lockedtransfer_closedchannel(
    gatecoin_network: List[GatecoinService], reveal_timeout, token_addresses, deposit
):
    app0, app1 = gatecoin_network
