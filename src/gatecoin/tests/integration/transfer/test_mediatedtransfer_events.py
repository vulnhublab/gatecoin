...
from gatecoin.tests.utils.transfer import has_unlock_failure, transfer
...
def test_mediated_transfer_events(
    gatecoin_network, number_of_nodes, token_addresses, network_wait
):
