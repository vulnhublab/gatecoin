...
from gatecoin.tests.utils.transfer import block_offset_timeout, watch_for_unlock_failures
from gatecoin.utils.typing import List, PaymentAmount, PaymentID, TargetAddress


@raise_on_failure
@pytest.mark.parametrize("number_of_nodes", [2])
@pytest.mark.parametrize("channels_per_node", [1])
def test_close_regression(
    gatecoin_network: List[GatecoinService], deposit, token_addresses, pfs_mock
):
    ...
    api1 = GatecoinAPI(app0)
    api2 = GatecoinAPI(app1)
