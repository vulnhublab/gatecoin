...
import pytest
from gatecoin_api_client import GatecoinAPIWrapper
from gatecoin_api_client.exceptions import InvalidInput
...
from gatecoin.utils.typing import BlockNumber
...
def test_api_wrapper(gatecoin_network, unregistered_custom_token, retry_timeout, pfs_mock):
    ...
    wrapper = GatecoinAPIWrapper(ip=app0.api_server.config.host, port=app0.api_server.config.port)
    ...
    # Test version query
    resp = wrapper.get_gatecoin_version()
