...
from gatecoin.constants import BLOCK_ID_LATEST, NULL_ADDRESS_HEX
from gatecoin.gatecoin_service import GatecoinService
from gatecoin.tests.integration.api.rest.test_rest import DEPOSIT_FOR_TEST_API_DEPOSIT_LIMIT
...
from gatecoin.tests.utils.events import check_dict_nested_attrs
from gatecoin.transfer import views
from gatecoin.transfer.state import ChannelState
from gatecoin.utils.typing import List, TokenAmount
from gatecoin.waiting import wait_for_participant_deposit
...
def test_api_channel_open_and_deposit_race(
    ...
    GatecoinRecoverableError in case of races. That needs to be properly handled
    and not allowed to bubble out of the greenlet.

    Regression test for https://github.com/gatecoin/gatecoin/issues/4937
    """
