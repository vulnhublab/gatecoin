...
from gatecoin.tests.utils.smartcontracts import deploy_rpc_test_contract
from gatecoin.tests.utils.transfer import TransferState, get_channelstate, transfer
from gatecoin.transfer import views
from gatecoin.transfer.architecture import BalanceProofSignedState
from gatecoin.transfer.state_change import ContractReceiveChannelSettled
from gatecoin.utils.packing import pack_signed_balance_proof
from gatecoin.utils.typing import BlockNumber, List, PaymentAmount, PaymentID, TokenAddress
...
def test_locksroot_loading_during_channel_settle_handling(  # pylint: disable=unused-argument
    ...
    waiting.wait_for_block(gatecoin=app1, block_number=pruned_block, retry_timeout=1)
