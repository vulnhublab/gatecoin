...
from gatecoin.tests.fixtures.variables import TransportProtocol
from gatecoin.tests.utils.transport import (
    ParsedURL,
    generate_synapse_config,
    matrix_server_starter,
)
from gatecoin.utils.http import HTTPExecutor
from gatecoin.utils.typing import Iterable, Optional, Tuple
...
def resolver_ports(number_of_nodes) -> List[Optional[int]]:
    ...
    By default, Gatecoin nodes start without hash resolvers.
