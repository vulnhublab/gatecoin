...
from gatecoin.network.proxies.monitoring_service import MonitoringService
from gatecoin.network.proxies.one_to_n import OneToN
...
from gatecoin.network.proxies.token import Token
...
from gatecoin.settings import MONITORING_REWARD
from gatecoin.tests.utils.smartcontracts import deploy_token
...
def max_token_networks_fixture() -> int:
    ...
    # https://github.com/gatecoin/gatecoin/blob/74598401b9ef994eef5e358a78cc176a01c9245d/gatecoin_contracts/data/source/gatecoin/TokenNetworkRegistry.sol#L81-L83
...
def token_addresses_fixture(
    ...
    potentially pre-registered with the Gatecoin Registry.
    ...
    Args:
        ...
        register_tokens: controls if tokens will be registered with gatecoin Registry
    """
    return [
...
def secret_registry_proxy_fixture(
    ...
    instantiate a Gatecoin proxy.

    The JSONRPCClient proxy just exposes the functions from the smart contract
    as methods in a generate python object, the Gatecoin proxy uses it to
