...
from gatecoin.exceptions import SamePeerAddress
...
def test_channel_with_self(
    gatecoin_network: List[GatecoinService], settle_timeout, token_addresses
):
    (app0,) = gatecoin_network  # pylint: disable=unbalanced-tuple-unpacking
