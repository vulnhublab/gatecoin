...
from gatecoin.tasks import SECURITY_EXPRESSION, _do_check_version
from gatecoin.tests.utils.mocks import MockGatecoinService

gatecoin_service = MockGatecoinService()

LATEST_RELEASE_RESPONSE = """{"url":
            "https://api.github.com/repos/gatecoin/gatecoin/releases/14541434",
            "assets_url":
            "https://api.github.com/repos/gatecoin/gatecoin/releases/14541434/assets",
            "upload_url":
            "https://uploads.github.com/repos/gatecoin/gatecoin/releases/14541434/assets{?name,label}",
            "html_url":
            "https://github.com/gatecoin/gatecoin/releases/tag/v0.19.0",
            ...
            "https://api.github.com/repos/gatecoin/gatecoin/releases/assets/10155617",
            "id": 10155617, "node_id":
            "MDEyOlJlbGVhc2VBc3NldDEwMTU1NjE3", "name":
            "gatecoin-v0.19.0-linux.tar.gz", "label": "", "uploader":
            ...
            "https://github.com/gatecoin/gatecoin/releases/download/v0.19.0/gatecoin-v0.19.0-linux.tar.gz"},
            {"url":
            "https://api.github.com/repos/gatecoin/gatecoin/releases/assets/10155709",
            "id": 10155709, "node_id":
            "MDEyOlJlbGVhc2VBc3NldDEwMTU1NzA5", "name":
            "gatecoin-v0.19.0-macOS.zip", "label": "", "uploader":
            {"login": "konradkonrad", "id": 3705643, "node_id":
            "MDQ6VXNlcjM3MDU2NDM=", "avatar_url":
            "https://avatars3.githubusercontent.com/u/3705643?v=4",
            "gravatar_id": "", "url":
            ...
            "https://github.com/gatecoin/gatecoin/releases/download/v0.19.0/gatecoin-v0.19.0-macOS.zip"}],
            "tarball_url":
            "https://api.github.com/repos/gatecoin/gatecoin/tarball/v0.19.0",
            "zipball_url":
            "https://api.github.com/repos/gatecoin/gatecoin/zipball/v0.19.0",
            ...
            some submitted by the users of Gatecoin in the Singapore
            ...
            mined when we try to send the transaction Gatecoin no longer
            crashes.- #3135 In development mode if more than 100 *
            (10^18) tokens are deposited then Gatecoin no longer
            crashes."}"""
...
def test_version_check_regex():
    ...
    assert (
        re.search(SECURITY_EXPRESSION, text6).group(0) == "[CRITICAL UPDATE: U+1F00 1F62D ❎ 😀]"
    )
...
def test_version_check_api_rate_limit_exceeded():
    ...
    with patch.object(requests, "get", side_effect=fake_request):
        assert not _do_check_version(version, gatecoin_service)
...
def test_version_check():
    ...
    with patch.object(requests, "get", side_effect=fake_request):
        assert not _do_check_version(version, gatecoin_service)
        assert _do_check_version(parse_version("0.19.0"), gatecoin_service)
