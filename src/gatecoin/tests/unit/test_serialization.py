...
from gatecoin.messages.metadata import Metadata
...
from gatecoin.messages.transfers import RevealSecret, SecretRequest
...
def test_decode_with_unknown_type():
    ...
    test_str = """{"_type": "gatecoin.tests.NonExistentClass"}"""
    with pytest.raises(SerializationError):
        JSONSerializer.deserialize(test_str)
...
def test_deserialize_without_metadata():
    ...
    Regression test for https://github.com/gatecoin/gatecoin/issues/7052
    """
    m = {
        "type": "LockedTransfer",
