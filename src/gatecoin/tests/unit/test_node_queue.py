...
from gatecoin.constants import EMPTY_HASH
from gatecoin.tests.utils import factories
from gatecoin.transfer import node, state, state_change
from gatecoin.transfer.events import SendWithdrawRequest
...
from gatecoin.transfer.state_change import ReceiveWithdrawConfirmation
