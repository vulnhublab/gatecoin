...
from gatecoin.storage.serialization.schemas import (
    AddressField,
    BytesField,
...
from gatecoin.storage.sqlite import GATECOIN_DB_VERSION, SerializedSQLiteStorage
...
def test_events_loaded_from_storage_should_deserialize(tmp_path):
    filename = Path(f"{tmp_path}/v{GATECOIN_DB_VERSION}_log.db")
...
def test_serialize_contract_send_subclass(chain_state):
    ...
    Regression test for https://github.com/gatecoin/gatecoin/issues/6075
    """
