...
from gatecoin.constants import EMPTY_HASH, MAXIMUM_PENDING_TRANSFERS
from gatecoin.gatecoin_service import initiator_init
from gatecoin.settings import DEFAULT_MEDIATION_FEE_MARGIN, MAX_MEDIATION_FEE_PERC
...
from gatecoin.tests.utils.transfer import assert_dropped
from gatecoin.transfer import channel
from gatecoin.transfer.architecture import State
...
from gatecoin.transfer.mediated_transfer import initiator, initiator_manager
...
from gatecoin.transfer.mediated_transfer.initiator import (
    calculate_fee_margin,
    calculate_safe_amount_with_fee,
)
from gatecoin.transfer.mediated_transfer.state import InitiatorPaymentState, InitiatorTransferState
...
from gatecoin.utils import typing
from gatecoin.utils.copy import deepcopy
from gatecoin.utils.transfers import random_secret
from gatecoin.utils.typing import Address, BlockNumber, FeeAmount, PaymentAmount, TokenAmount
...
def test_init_with_fees_more_than_max_limit():
    ...
    reason_msg = (
        ...
        "(see https://gatecoin.readthedocs.io/en/stable/using-gatecoin-on-mainnet/overview.html#frequently-asked-questions)"  # noqa
    )
...
def test_refund_transfer_no_more_routes():
    ...
    # https://github.com/gatecoin/gatecoin/issues/3146#issuecomment-447378046
...
def test_initiator_init():
    ...
    with patch(
        "gatecoin.routing.get_best_routes", return_value=(None, route_states, feedback_token)
    ) as best_routes:
