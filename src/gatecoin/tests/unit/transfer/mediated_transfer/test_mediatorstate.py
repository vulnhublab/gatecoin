...
from gatecoin.transfer import channel, routes
...
from gatecoin.transfer.mediated_transfer import mediator
...
from gatecoin.transfer.mediated_transfer.mediator import get_payee_channel, set_offchain_secret
from gatecoin.transfer.mediated_transfer.state import MediationPairState, MediatorTransferState
...
def test_payee_timeout_must_be_equal_to_payer_timeout():
    ...
    #  3! New block is mined and Gatecoin learns about it
...
def test_resume_waiting_transfer():
    ...
    # see: https://github.com/gatecoin/gatecoin/issues/4998
    iteration = mediator.state_transition(
        mediator_state=None,
        state_change=mediator_make_init_action(channels, transfer),
        channelidentifiers_to_channels=channels.channel_map,
...
def test_imbalance_penalty_at_insufficent_payer_balance():
    ...
    Regression test for https://github.com/gatecoin/gatecoin/issues/4835
    """
