...
from gatecoin.transfer.mediated_transfer.state import MediatorTransferState
from gatecoin.transfer.mediated_transfer.state_change import (
    ActionInitMediator,
    ReceiveLockExpired,
    ReceiveSecretReveal,
)
from gatecoin.transfer.state import message_identifier_from_prng
from gatecoin.transfer.state_change import Block, ContractReceiveSecretReveal
from gatecoin.utils.signer import LocalSigner
from gatecoin.utils.typing import BlockExpiration
...
def test_payer_enter_danger_zone_with_transfer_payed():
    ...
    Issue: https://github.com/gatecoin/gatecoin/issues/1013
    """
    block_number = 5
...
def test_regression_mediator_not_update_payer_state_twice():
    """Regression Test for https://github.com/gatecoin/gatecoin/issues/3086
