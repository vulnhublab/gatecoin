...
from gatecoin.constants import EMPTY_SECRET, EMPTY_SECRET_SHA256, LOCKSROOT_OF_NO_LOCKS, UINT64_MAX
...
from gatecoin.transfer.events import ContractSendSecretReveal, SendProcessed
from gatecoin.transfer.mediated_transfer import target
...
def test_handle_offchain_secretreveal_after_lock_expired():
    ...
    Target part for https://github.com/gatecoin/gatecoin/issues/3086
    """
    setup = make_target_state()
