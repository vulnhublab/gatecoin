...
from gatecoin.transfer.mediated_transfer.state import InitiatorPaymentState
...
def test_get_networks(chain_state, token_network_address):
    ...
    chain_state.identifiers_to_tokennetworkregistries[token_network_registry_empty.address] = (
