...
from gatecoin.exceptions import InvalidSignature
from gatecoin.network.utils import get_average_http_response_time
from gatecoin.settings import CapabilitiesConfig
from gatecoin.transfer.utils.secret import decrypt_secret, encrypt_secret
from gatecoin.utils.capabilities import capconfig_to_dict, capdict_to_config
from gatecoin.utils.keys import privatekey_to_publickey
from gatecoin.utils.signer import LocalSigner, Signer, recover
from gatecoin.utils.typing import UserID
...
def test_deserialize_capabilities():
    ...
    base_url = "mxc://gatecoin.network/cap"
