...
from gatecoin.exceptions import InvalidDBData
...
from gatecoin.storage.wal import WriteAheadLog, restore_state
...
from gatecoin.transfer.architecture import State, StateChange, TransitionResult
from gatecoin.transfer.events import EventPaymentSentFailed
from gatecoin.transfer.state_change import Block, ContractReceiveChannelBatchUnlock
from gatecoin.utils.typing import BlockGasLimit, BlockNumber, Callable, List, TokenAmount
...
def test_wal_has_version():
    ...
    assert wal.version == GATECOIN_DB_VERSION
