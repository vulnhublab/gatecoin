...
from gatecoin.utils.typing import Address, AddressHex, Signature
...
class Signer(ABC):
    ...
    # issue: https://github.com/gatecoin/gatecoin/issues/3390
    # @abstractmethod
...
class LocalSigner(Signer):
    ...
    def sign(self, data: bytes, v: int = 27) -> Signature:
        ...
        assert v in (0, 27), "Gatecoin is only signing messages with v in (0, 27)"
