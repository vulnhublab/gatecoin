...
from gatecoin.constants import DAI_TOKEN_ADDRESS, WETH_TOKEN_ADDRESS
from gatecoin.settings import DEFAULT_DAI_FLAT_FEE, DEFAULT_WETH_FLAT_FEE, MediationFeeConfig
from gatecoin.utils.typing import Dict, FeeAmount, ProportionalFeeAmount, TokenAddress, Tuple
...
def ppm_fee_per_channel(per_hop_fee: ProportionalFeeAmount) -> ProportionalFeeAmount:
    ...
    See https://gatecoin-specification.readthedocs.io/en/latest/mediation_fees.html
