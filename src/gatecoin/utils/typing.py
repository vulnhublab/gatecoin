...
from gatecoin_contracts.utils.type_aliases import (  # NOQA pylint:disable=unused-import
    AdditionalHash,
    BalanceHash,
    BlockExpiration,
    ChainID,
...
if TYPE_CHECKING:
    ...
    from gatecoin.messages.monitoring_service import SignedBlindedBalanceProof  # noqa: F401
    from gatecoin.transfer.mediated_transfer.state import (  # noqa: F401
        InitiatorTransferState,
        LockedTransferSignedState,
        LockedTransferUnsignedState,
    )
    from gatecoin.transfer.state import (  # noqa: F401
        HashTimeLockState,
        NettingChannelState,
        NetworkState,
...
T_GatecoinProtocolVersion = int
GatecoinProtocolVersion = NewType("GatecoinProtocolVersion", T_GatecoinProtocolVersion)

T_GatecoinDBVersion = int
GatecoinDBVersion = NewType("GatecoinDBVersion", T_GatecoinDBVersion)
...
ErrorType = Union[Type["GatecoinRecoverableError"], Type["GatecoinUnrecoverableError"]]
