...
import gatecoin_contracts.constants
from gatecoin.constants import MATRIX_AUTO_SELECT_SERVER, Environment
from gatecoin.network.pathfinding import PFSConfig
...
from gatecoin_contracts.contract_manager import ContractDevEnvironment, contracts_precompiled_path
...
# - Network latency
# - The Gatecoin node might not be able to process the messages immediately
DEFAULT_TRANSPORT_MATRIX_SYNC_LATENCY = 15_000
DEFAULT_MATRIX_KNOWN_SERVERS = {
    Environment.PRODUCTION: (
        "https://raw.githubusercontent.com/gatecoin/gatecoin-service-bundle"
...
GATECOIN_CONTRACT_VERSION = gatecoin_contracts.constants.CONTRACTS_VERSION
...
class GatecoinConfig:
    ...
    contracts_path: Path = contracts_precompiled_path(GATECOIN_CONTRACT_VERSION)
    ...
    transport: MatrixTransportConfig = MatrixTransportConfig(
        # None causes fetching from url in gatecoin.settings.py::DEFAULT_MATRIX_KNOWN_SERVERS
        available_servers=[],
