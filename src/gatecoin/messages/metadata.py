...
from gatecoin.messages.abstract import cached_property
from gatecoin.storage.serialization import serializer
from gatecoin.transfer.mediated_transfer.events import SendLockedTransfer
from gatecoin.transfer.state import get_address_metadata
from gatecoin.transfer.utils.secret import encrypt_secret
...
class RouteMetadata(MetadataValidation):
    ...
    class Meta:
        ...
        gatecoin.storage.serialization.schema.BaseSchemaOpts and the standard marshmallow options.
...
class Metadata:
    ...
    class Meta:
        """
        Sets meta-options for the Schema as defined in
        gatecoin.storage.serialisation.schema.BaseSchemaOpts and the standard marshmallow options.
