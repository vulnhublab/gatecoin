...
from gatecoin.api.objects import Address, AddressList, PartnersPerToken, PartnersPerTokenList
...
from gatecoin.settings import DEFAULT_INITIAL_CHANNEL_TARGET, DEFAULT_JOINABLE_FUNDS_TARGET
from gatecoin.storage.serialization.schemas import IntegerToStringField
from gatecoin.storage.utils import TimestampedEvent
from gatecoin.transfer import channel
from gatecoin.transfer.state import ChainState, ChannelState, NettingChannelState, RouteState
from gatecoin.transfer.views import get_token_network_by_address
from gatecoin.utils.capabilities import _bool_to_binary, int_bool
from gatecoin.utils.typing import Address as AddressBytes, AddressHex
...
class CapabilitiesField(fields.Field):
    ...
    def _serialize(value, attr, obj, **kwargs):  # pylint: disable=unused-argument
        ...
        return f"mxc://gatecoin.network/cap?{url_encode(capdict)}"
...
class GatecoinEventsRequestSchema(BaseSchema):
