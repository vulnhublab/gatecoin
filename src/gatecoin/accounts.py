...
from gatecoin.utils.typing import Address, AddressHex, PrivateKey, PublicKey
...
class KeystoreFileNotFound(GatecoinError):
    """A keystore file for a user provided account could not be found."""


class KeystoreAuthenticationError(GatecoinError):
