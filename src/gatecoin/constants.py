...
LATEST = "https://api.github.com/repos/gatecoin/gatecoin/releases/latest"
RELEASE_PAGE = "https://github.com/gatecoin/gatecoin/releases"
DOC_URL = "https://gatecoin.readthedocs.io/en/latest/rest_api.html"
SECURITY_EXPRESSION = r"\[CRITICAL UPDATE.*?\]"

GATECOIN_DB_VERSION = GatecoinDBVersion(27)
SQLITE_MIN_REQUIRED_VERSION = (3, 9, 0)
PROTOCOL_VERSION = GatecoinProtocolVersion(1)
...
# An arbitrary limit for transaction size in Gatecoin, added in PR #1990
...
# See gas measurements in gatecoin contracts for these values, rounded up
...
# https://github.com/gatecoin/gatecoin/blob/fff8646ebcf2c812f40891c2825e12ed03cc7628/gatecoin_contracts/contracts/TokenNetwork.sol#L213
