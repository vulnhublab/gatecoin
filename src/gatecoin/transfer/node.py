...
from gatecoin.transfer.mediated_transfer import initiator_manager, mediator, target
...
from gatecoin.transfer.state import ChainState, TokenNetworkRegistryState, TokenNetworkState
...
def is_transaction_effect_satisfied(
    ...
    was settled), new transactions can be dispatched by Gatecoin as a side effect for the
    ...
    #   proof
    # - A larger gatecoin state change nonce is impossible.
