...
from gatecoin.constants import ABSENT_SECRET
...
from gatecoin.transfer.architecture import Event, TransitionResult
from gatecoin.transfer.events import (
    EventInvalidSecretRequest,
    EventPaymentSentFailed,
    EventPaymentSentSuccess,
)
from gatecoin.transfer.identifiers import CANONICAL_IDENTIFIER_UNORDERED_QUEUE
...
from gatecoin.transfer.state_change import Block, ContractReceiveSecretReveal, StateChange
from gatecoin.transfer.utils import is_valid_secret_reveal
...
def calculate_safe_amount_with_fee(
    ...
    https://github.com/gatecoin/gatecoin-services/issues/569.
    """
...
def handle_block(
    ...
    if lock_has_expired and initiator_state.transfer_state != "transfer_expired":
        ...
        #       would have to fail.
        #       Related issue: https://github.com/gatecoin/gatecoin/issues/2329
        ...
        return TransitionResult(
            ...
            # Check https://github.com/gatecoin/gatecoin/issues/3183
...
def try_new_route(
    ...
    try:
        ...
        for route_state in candidate_route_states:
            ...
            # https://github.com/gatecoin/gatecoin/issues/4751
