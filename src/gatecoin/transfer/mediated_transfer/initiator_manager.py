...
from gatecoin.transfer.mediated_transfer import initiator
...
from gatecoin.transfer.state import NettingChannelState, RouteState, get_address_metadata
from gatecoin.transfer.state_change import ActionCancelPayment, Block, ContractReceiveSecretReveal
...
def handle_lock_expired(
    ...
    Related issue: https://github.com/gatecoin/gatecoin/issues/3183"""
