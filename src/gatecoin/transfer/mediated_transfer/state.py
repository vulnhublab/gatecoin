...
from gatecoin.constants import EMPTY_SECRETHASH, LOCKSROOT_OF_NO_LOCKS
...
if TYPE_CHECKING:
    ...
    from gatecoin.transfer.mediated_transfer.events import SendSecretReveal  # noqa
...
class MediationPairState(State):
    ...
    #   The payee is following the gatecoin protocol and has sent a SecretReveal.
    #
