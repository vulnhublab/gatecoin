...
from gatecoin.exceptions import UndefinedMediationFee
from gatecoin.transfer import channel, routes, secret_registry
...
from gatecoin.transfer.mediated_transfer.mediation_fee import FeeScheduleState, Interpolate
...
from gatecoin.transfer.state_change import Block, ContractReceiveSecretReveal, ReceiveUnlock
...
def events_for_expired_pairs(
    ...
    for pair in pending_transfers_pairs:
        ...
        if has_payer_transfer_expired:
            ...
            # is running Gatecoin without a monitoring service, then it may go
...
def handle_block(
    ...
    """After Gatecoin learns about a new block this function must be called to
