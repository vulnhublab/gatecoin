...
from gatecoin.constants import EMPTY_SECRETHASH
from gatecoin.transfer.architecture import AuthenticatedSenderStateChange, StateChange
...
from gatecoin.transfer.state_change import BalanceProofStateChange
