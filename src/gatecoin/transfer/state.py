...
from gatecoin.utils.validation import MetadataValidation
...
class HashTimeLockState(State):
    ...
    def __post_init__(self) -> None:
        ...
        from gatecoin.messages.transfers import Lock  # put here to avoid cyclic dependencies
...
class TokenNetworkRegistryState(State):
    ...
    def __init__(
        ...
        # https://github.com/gatecoin/gatecoin/commit/922e4fdf0d54c150c1bada0d101f8085e04b68bd
    ...
    def add_token_network(self, token_network: TokenNetworkState) -> None:
        ...
        self.tokenaddresses_to_tokennetworkaddresses[token_network.token_address] = (
