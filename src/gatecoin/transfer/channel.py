...
from gatecoin.constants import LOCKSROOT_OF_NO_LOCKS, MAXIMUM_PENDING_TRANSFERS, UINT256_MAX
from gatecoin.settings import DEFAULT_NUMBER_OF_BLOCK_CONFIRMATIONS, MediationFeeConfig
from gatecoin.transfer.architecture import Event, StateChange, SuccessOrError, TransitionResult
...
from gatecoin.transfer.identifiers import CANONICAL_IDENTIFIER_UNORDERED_QUEUE, CanonicalIdentifier
...
from gatecoin.transfer.mediated_transfer.state import (
...
from gatecoin.utils.packing import pack_balance_proof, pack_withdraw
...
if TYPE_CHECKING:
    ...
    from gatecoin.gatecoin_service import GatecoinService  # noqa: F401
...
def get_safe_initial_expiration(
    ...
    reveal_timeout`, otherwise for off-chain transfers Gatecoin would be slower
    than blockchain.
    """
    if lock_timeout:
...
def get_capacity(channel_state: NettingChannelState) -> TokenAmount:
    ...
    https://gatecoin.readthedocs.io/en/stable/glossary.html#term-Channel-capacity
    """
    return TokenAmount(
...
def _get_balance(
    ...
    https://gatecoin.readthedocs.io/en/stable/glossary.html#term-Balance
    """
