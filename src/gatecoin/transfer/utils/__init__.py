...
if TYPE_CHECKING:
    ...
    from gatecoin.transfer.mediated_transfer.state_change import ReceiveSecretReveal  # noqa: F401
    from gatecoin.transfer.state_change import ContractReceiveSecretReveal  # noqa: F401
