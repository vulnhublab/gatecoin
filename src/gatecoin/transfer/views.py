...
from gatecoin.transfer.architecture import ContractSendEvent, TransferTask
from gatecoin.transfer.identifiers import CanonicalIdentifier
from gatecoin.transfer.mediated_transfer.tasks import InitiatorTask, TransferRole
...
def state_from_gatecoin(gatecoin: "GatecoinService") -> ChainState:  # pragma: no unittest
    assert gatecoin.wal, "gatecoin.wal not set"
    return gatecoin.wal.get_current_state()
...
def get_confirmed_blockhash(gatecoin: "GatecoinService") -> BlockHash:
    return state_from_gatecoin(gatecoin).block_hash
