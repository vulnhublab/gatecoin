...
from gatecoin.exceptions import MatrixSyncMaxTimeoutReached, TransportError
from gatecoin.messages.abstract import Message
from gatecoin.network.transport.matrix.sync_progress import SyncProgress
from gatecoin.utils.debugging import IDLE
from gatecoin.utils.notifying_queue import NotifyingQueue
from gatecoin.utils.typing import Address, AddressHex, AddressMetadata
...
@dataclass
class ReceivedGatecoinMessage(_ReceivedMessageBase):
    message: Message
...
class GMatrixClient(MatrixClient):
    ...
    def start_listener_thread(
        ...
        #     Ctrl-C before this is run, and Gatecoin newer shutting down.
