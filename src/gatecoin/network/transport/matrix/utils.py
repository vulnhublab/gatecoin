...
from gatecoin.exceptions import InvalidSignature, SerializationError, TransportError
from gatecoin.messages.abstract import Message, RetrieableMessage, SignedMessage
...
def sort_servers_closest(
    ...
    This increases the timeout so that the network hiccups won't cause Gatecoin startup failures.
    """
