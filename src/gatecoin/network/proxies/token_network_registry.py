...
from gatecoin.constants import BLOCK_ID_LATEST, NULL_ADDRESS_BYTES
...
from gatecoin_contracts.constants import CONTRACT_SECRET_REGISTRY, CONTRACT_TOKEN_NETWORK_REGISTRY
...
class TokenNetworkRegistry:
    ...
    def add_token(
        ...
        The limits apply for version 0.13.0 and above of gatecoin-contracts,
        ...
        try:
            ...
            if chain_id != self.rpc_client.chain_id:
                raise BrokenPreconditionError(
                    ...
                    f"network Gatecoin is running on: {self.rpc_client.chain_id}."
                )
