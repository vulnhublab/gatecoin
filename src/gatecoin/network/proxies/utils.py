...
from gatecoin.utils.formatting import format_block_id
from gatecoin.utils.typing import BlockIdentifier, NoReturn


def raise_on_call_returned_empty(given_block_identifier: BlockIdentifier) -> NoReturn:
    """Format a message and raise GatecoinUnrecoverableError."""
