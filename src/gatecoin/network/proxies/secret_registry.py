...
class SecretRegistry:
    ...
    def _register_secret_batch(
        ...
        exception: Union[GatecoinRecoverableError, GatecoinUnrecoverableError]
        if unrecoverable_error:
            ...
            if transaction_mined is not None:
                ...
                if receipt["gasUsed"] == transaction_mined.startgas:
                    ...
                    error = (
                        ...
                        "a configuration error in Gatecoin."
                    )
                else:
                ...
                exception = GatecoinUnrecoverableError(error)
            ...
            exception = GatecoinRecoverableError(error)
            transaction_result.set_exception(exception)
            raise exception
