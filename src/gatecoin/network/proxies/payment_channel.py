...
from gatecoin.network.proxies.token_network import ChannelDetails, TokenNetwork, WithdrawInput
...
from gatecoin_contracts.constants import CONTRACT_TOKEN_NETWORK, ChannelEvent
