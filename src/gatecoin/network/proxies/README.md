...
This document explains how Gatecoin synchronizes with the blockchain and handles
corner cases.

### Synchronization

Gatecoin's Smart Contracts are optimized to save gas. One of the biggest
...
Gatecoin's approach to handle events is simple:
...
[#705](https://github.com/gatecoin/gatecoin/issues/705)
...
([#6182](https://github.com/gatecoin/gatecoin/issues/6182)).
