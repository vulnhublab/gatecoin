...
@dataclass
class GatecoinContractFilter:
    """Information to construct a filter for all relevant Gatecoin contract events"""
    ...
    def union(self, other: "GatecoinContractFilter") -> "GatecoinContractFilter":
        """Return a new GatecoinContractFilter with all elements from both input filters"""
