...
DESCRIPTION = 'µGateCoin is an off-chain, cheap, scalable and low-latency micropayment solution.'
VERSION = open('microcoin/VERSION', 'r').read().strip()
...
class CompileWebUI(Command):
    description = 'use npm to compile webui code to gatecoin/ui/web/dist'
    user_options = [
...
config = {
    ...
    'url': 'https://github.com/gatecoin/gatecoin',
    ...
    'license': 'MIT',
    'keywords': 'gatecoin ethereum microcoin blockchain',
    'install_requires': read_requirements('requirements.txt'),
    'extras_require': {'dev': read_requirements('requirements-dev.txt')},
    'packages': find_packages(exclude=['test']),
    'package_data': {'microcoin': ['data/contracts.json',
                                     'webui/js/*',
                                     'webui/index.html',
                                     'webui/microcoin/dist/umd/microcoin.js',
                                     'VERSION']},
    'classifiers': [
