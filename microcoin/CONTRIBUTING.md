# µGateCoin Development Guide

Welcome! This guide serves as the guideline to contributing to the µGateCoin Network
codebase. It's here to help you understand what development practises we use here
and what are the requirements for a Pull Request to be opened against µGateCoin.
...
If you experience a problem while using µGateCoin or want to request a feature then you should open an issue against the repository. All issues should contain:

**For Feature Requests:**
- A description of what you would like to see implemented
- An explanation of why you believe this would make a good addition to µGateCoin

**For Bugs:**
- A short description of the problem
- Detailed description of your system, µGateCoin version, geth version, solidity version e.t.c.
- What was the exact unexpected thing that occurred
- What you were expecting to happen instead

### Creating a Pull Request

If you have some coding abilities and would like to contribute to the actual codebase of µGateCoin then you can open a Pull Request(PR) against the repository.
...
approved review from one of the core developers of µGateCoin and also all Continuous Integration tests should be passing and the CI build should be green.
...
Tests, especially integration tests, will take some time. If you want to run single tests simply specify them on the command line, like so:
    ...
    env/bin/pytest microcoin/tests/<path-to-test(s)>

## Development Guidelines

In this section we are going to describe the coding rules for contributing to the µGateCoin repository. All code you write should strive to comply with these rules.
...
µGateCoin is written in Python and we follow the official Python style guide [PEP8](https://www.python.org/dev/peps/pep-0008/). It is highly
...
the core developers of µGateCoin and you should try to incorporate that feedback into your branch. Once you do so and all tests
pass your feature/fix will be merged.

#### Contributing to other people's PRs

If you are a core developer of µGateCoin with write privileges to the repository then you can add commits or rebase to master
any Pull Request by other people.

Let us take [this](https://github.com/gatecoin/microcoin/pull/103) PR as an example. The contributor has everything ready
...
```
git remote add pcppcp git@github.com:pcppcp/microcoin.git
git fetch pcppcp
