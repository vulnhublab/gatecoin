...
from microcoin.utils import privkey_to_addr
import logging
import requests
...
from microcoin import utils, constants
from microcoin.config import NETWORK_CFG
from microcoin.exceptions import StateFileLocked, InsecureStateFile, NetworkIdMismatch
    ...
    while True:
        try:
            ...
            if not state_file:
                ...
                app_dir = click.get_app_dir('microcoin')
            ...
            log.warning('Another uGatecoin process is already running (%s)!' % str(ex))
