...
/**
 * [[MicroCoin.channel]] state data blueprint
 */
export interface MicroChannel {
  ...
  proof: MicroProof;
  /**
   * Next balance proof, persisted with [[MicroCoin.confirmPayment]]
   */
...
/**
 * [[MicroCoin.getChannelInfo]] result
 */
...
/**
 * Main MicroCoin client class
 *
 * Contains all methods to interact with a MicroCoin channel through a web3
 * instance.
 */
export class MicroCoin {
  /**
   * Web3 instance
   */
  web3: Web3;
