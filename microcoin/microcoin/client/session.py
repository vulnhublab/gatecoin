...
from microcoin.header import HTTPHeaders
from microcoin.client import Client, Channel
from microcoin.utils import verify_balance_proof
...
class Session(requests.Session):
    ...
    def close_channel(self, endpoint_url: str = None):
        ...
        # We need to call request directly because delete would perform a uGatecoin request.
        try:
