...
Example::
    ...
    $ python -m microcoin.close_all_channels --private-key ~/.keys/my_key.json
"""
import logging
import os
import sys
...
if __package__ is None:
    # add /microcoin/ to path
    path = os.path.abspath(os.path.join(os.path.dirname(__file__), '../'))
    sys.path.insert(0, path)
    # remove /microcoin/microcoin/ from path
...
from microcoin import (
    config,
    utils,
    constants,
)
from microcoin.channel_manager import ChannelManagerState
from microcoin.exceptions import StateFileException
from microcoin.make_helpers import make_channel_manager_contract
