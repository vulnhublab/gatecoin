from microcoin.proxy.resources.expensive import Expensive
...
from microcoin.constants import MICROCOIN_DIR
...
class PaywalledProxyUrl(Expensive):
    ...
    def __init__(self, domain=None, *args, **kwargs):
        ...
        self.paywall_html, self.paywall_header = self.extract_paywall_body(
            os.path.join(MICROCOIN_DIR, 'microcoin/webui/index.html')
        )
        self.domain = domain
