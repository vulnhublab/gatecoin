...
from microcoin.channel_manager import (
    ChannelManager
)

from microcoin.proxy.resources import (
    Expensive,
...
from microcoin.proxy.resources.expensive import LightClientProxy
from microcoin.constants import API_PATH, HTML_DIR, JSLIB_DIR, JSPREFIX_URL
from microcoin.proxy.resources.paywall_decorator import Paywall
