...
from microcoin import Session
from microcoin.channel_manager import ChannelManager
from microcoin.examples.ticker_proxy import ETHTickerProxy
from microcoin.examples.ticker_client import ETHTickerClient
from microcoin.examples.echo_server import run as run_echo_server
from microcoin.examples.echo_client import run as run_echo_client
from microcoin.proxy.paywalled_proxy import PaywalledProxy
from microcoin.proxy.resources import PaywalledProxyUrl
import microcoin.client.session
...
def patch_session(web3, monkeypatch):
    ...
    monkeypatch.setattr(
        microcoin.client.session.Session,
