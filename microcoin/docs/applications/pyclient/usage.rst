...
The µGateCoin client can be used as a standalone library, to make machine-to-machine payments easily available.


An example use of the library would import the :py:class:`~mircogatecoin.Client` :doc:`class </applications/pyclient/components-overview>`:
...
An example lifecycle of a :py:class:`~mircogatecoin.Client` object could look like this:
