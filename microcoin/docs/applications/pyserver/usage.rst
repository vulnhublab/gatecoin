...
To try them, run one of the following commands from a Python environment containing a successful µGateCoin installation:

.. code:: bash

    python3 -m microcoin.examples.demo_proxy --private-key <path_to_private_key_file> start

or

.. code:: bash

    python3 -m microcoin.examples.wikipaydia --private-key <path_to_private_key_file> --private-key-password-file <path_to_password_file> start
