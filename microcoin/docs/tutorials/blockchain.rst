...
To be able to use the echo client, you have to get the “TKN” Token configured for the GetMicroTransferChannels on Ropsten.


Directly with the TKN smart contract
~~~~~~~~~~~~~~~~~~~~~~~~~~
On the main page (https://github.com/gatecoin/microcoin) the Token addresses are listed, for Ropsten it can be found `here <https://ropsten.etherscan.io/address/0xff24d15afb9eb080c089053be99881dd18aa1090>`_


With our demo app
~~~~~~~~~~~~~~~~~~~~~~~~~~
The easiest way to get some TKN on the Ropsten-network is to use our JavaScript application
that we host with our µGateCoin `live-demos <https://demo.micro.gatecoin.network>`_.
...
2) visit e.g. the fortune cookie demo `here <https://demo.micro.gatecoin.network/fortunes_en>`_
...
**Now you're good to go! Check out the other Tutorials and get started with µGateCoin!**
