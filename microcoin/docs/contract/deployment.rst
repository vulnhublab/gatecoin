...
Note - you can change RPC/IPC chain connection, timeout parameters etc. in `contracts/project.json <https://github.com/gatecoin/microcoin/blob/master/contracts/project.json>`__
...
#. Modify the `project.json <https://github.com/gatecoin/microcoin/blob/master/contracts/project.json#L179>`__ to change the default account
...
#. Modify the `project.json <https://github.com/gatecoin/microcoin/blob/master/contracts/project.json#L49>`__ to change the default account
...
#. Modify the `/contracts/project.json <https://github.com/gatecoin/microcoin/blob/master/contracts/project.json#L214>`__ to change the default account
