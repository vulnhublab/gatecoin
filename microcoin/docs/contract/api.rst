...
.. _Auto-Generated-API: https://github.com/gatecoin/microcoin/blob/master/docs/contract/GetMicroTransferChannels.md
...
::
    ...
    pip install soldocs
    populus compile
    soldocs --input build/contracts.json --output docs/contract/GetMicroTransferChannels.md --contracts GetMicroTransferChannels
...
.. code:: python
    ...
    # balance_msg_sig is signed by the Receiver inside the microcoin code
    closing_sig
