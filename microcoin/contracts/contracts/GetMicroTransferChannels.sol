...
/// @title Gatecoin MicroTransfer Channels Contract.
contract GetMicroTransferChannels {
    ...
    /// @notice Constructor for creating the uGatecoin microtransfer channels contract.
    /// @param _token_address The address of the Token used by the uGatecoin contract.
    ...
    function GetMicroTransferChannels(
